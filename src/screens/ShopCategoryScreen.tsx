...
export const ShopCategoryScreen: React.FC = () => {
    ...
    const renderSimplifiedView = () => {
        ...
        return (
            <div className="bg-white dark:bg-[#1e2330] rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800">
                <div className="space-y-4">
                    {(defaultProduct.variants || []).map(variant => (
                        <div key={variant.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                            <div className="flex items-center gap-3">
                                <span className="font-bold text-gray-900 dark:text-white text-lg">
                                    {isClothing ? `Maat: ${variant.name}` : `${variant.name} sjaaltje`}
                                </span>
                                {isClothing && (
                                    <button onClick={() => handleDeleteVariant(defaultProduct.id, variant.id)} className="text-gray-400 hover:text-red-500 transition-colors">
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="w-12 h-12 rounded-full bg-white dark:bg-gray-700 shadow-sm border border-gray-200 dark:border-gray-600 flex items-center justify-center active:scale-90 transition-transform"
                                >
                                    <span className="material-icons-round text-gray-900 dark:text-white">remove</span>
                                </button>
                                ...
                                <input
                                    ...
                                    className="w-20 h-12 text-center bg-white dark:bg-gray-900 rounded-xl font-black text-xl text-gray-900 dark:text-white outline-none border-2 border-gray-200 dark:border-gray-700 focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all shadow-inner"
                                />
                                ...
                                <button
                                    ...
                                    className="w-12 h-12 rounded-full bg-white dark:bg-gray-700 shadow-sm border border-gray-200 dark:border-gray-600 flex items-center justify-center active:scale-90 transition-transform"
                                >
                                    <span className="material-icons-round text-gray-900 dark:text-white">add</span>
                                </button>
                            </div>
                        </div>
                    ))}
                    ...
                    {isClothing && (
                        <button
                            ...
                            className="w-full py-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800 rounded-xl font-bold text-gray-700 dark:text-gray-300 border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center gap-2 active:scale-[0.97] transition-all mt-4"
                        >
                            <span className="material-icons-round text-xl text-gray-700 dark:text-gray-300">add</span>
                            MAAT TOEVOEGEN
                        </button>
                    )}
                </div>
            ...
            return (
                <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
                    ...
                    <button
                        ...
                        className="w-full max-w-[200px] py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-bold shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-all"
                    >
                    ...
                    {(product.variants || []).map(variant => (
                        <div key={variant.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                            <div className="flex items-center gap-3">
                                ...
                                <button onClick={() => handleDeleteVariant(product.id, variant.id)} className="text-gray-400 hover:text-red-500">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="w-10 h-10 rounded-full bg-white dark:bg-gray-700 shadow-sm border border-gray-200 dark:border-gray-600 flex items-center justify-center active:scale-90 transition-transform"
                                >
                                    <span className="material-icons-round text-gray-900 dark:text-white">remove</span>
                                </button>
                                ...
                                <input
                                    ...
                                    className="w-24 h-12 text-center bg-white dark:bg-gray-900 rounded-xl font-black text-xl text-gray-900 dark:text-white outline-none border-2 border-gray-200 dark:border-gray-700 focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all shadow-inner"
                                />
        ...
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#0f172a] pb-20">
            <header className="px-6 py-4 flex items-center justify-between bg-white dark:bg-[#1e2330] shadow-sm sticky top-0 z-10">
                ...
                {!isSimplifiedView && (
                    <button
                        onClick={() => setIsProductModalOpen(true)}
                        className="p-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full shadow-lg active:scale-95 transition-all flex items-center justify-center"
                    >
                        <span className="material-icons-round">add</span>
                    </button>
                )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-[#1e2330] w-full max-w-sm rounded-[2rem] p-8 shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <input
                            ...
                            className="w-full p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl mb-6 outline-none border-2 border-gray-200 dark:border-gray-700 focus:border-primary transition-all text-gray-900 dark:text-white font-bold"
                            autoFocus
                        />
                        <div className="flex gap-3">
                            <button
                                onClick={() => setIsProductModalOpen(false)}
                                className="flex-1 py-4 bg-gray-200 dark:bg-gray-700 rounded-2xl font-bold text-gray-600 dark:text-gray-300 active:scale-95 transition-transform"
                            >
                                Annuleren
                            </button>
                            <button
                                onClick={handleAddProduct}
                                className="flex-1 py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-bold shadow-lg active:scale-95 transition-transform"
                            >
                                Toevoegen
                            </button>
                        </div>
            ...
            {isVariantModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-[#1e2330] w-full max-w-sm rounded-[2rem] p-8 shadow-2xl animate-in zoom-in-95 duration-200">
                        <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-2">{isClothing ? 'Maat toevoegen' : 'Variant toevoegen'}</h2>
                        ...
                        <input
                            ...
                            className="w-full p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl mb-6 outline-none border-2 border-gray-200 dark:border-gray-700 focus:border-primary transition-all text-gray-900 dark:text-white font-bold text-xl text-center"
                            autoFocus
                        />
                        <div className="flex gap-3">
                            <button
