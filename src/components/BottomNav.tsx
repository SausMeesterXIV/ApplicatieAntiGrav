...
export const BottomNav: React.FC<BottomNavProps> = ({ notifications = [] }) => {
  ...
  return (
    <nav
      className="absolute bottom-0 w-full bg-gray-50 dark:bg-[#0f172a] border-t border-gray-200 dark:border-gray-800 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] pt-2 px-4 z-50 transition-colors duration-200"
